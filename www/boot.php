...
:centos5
kernel http://centos.mirror.ptisp.pt/centos/5.11/os/x86_64/images/pxeboot/vmlinuz unsupported_hardware text NOVERIFYSSL ks=http://172.17.200.10/ks5.cfg
initrd http://centos.mirror.ptisp.pt/centos/5.11/os/x86_64/images/pxeboot/initrd.img
initrd http://172.17.200.10/dd.img
boot
